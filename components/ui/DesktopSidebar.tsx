...
export default function DesktopSidebar() {
  ...
  return (
    <aside
      ...
      style={{ width: 220, background: "#1C1410", height: "100vh" }}
    >
      ...
      <nav style={{ flex: 1, padding: "20px 0" }}>
        <p style={{ fontSize: 9, letterSpacing: "0.14em", color: "rgba(255,255,255,0.25)", padding: "0 24px 8px" }}>
          MAIN
        </p>
      ...
      <div style={{ padding: "20px 24px", borderTop: "0.5px solid rgba(255,255,255,0.08)" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{ width: 32, height: 32, borderRadius: "50%", background: "#8B3018", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12, color: "#F5DDD3", fontWeight: 500, flexShrink: 0 }}>
            {initial}
          </div>
